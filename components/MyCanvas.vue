...
export default {
  ...
  mounted () {
    ...
    this.provider.context = this.$refs['my-canvas'].getContext('webgl')
    ...
    gl.viewport(0.0, 0.0, this.$refs['my-canvas'].width, this.$refs['my-canvas'].height);
    ...
    /*=================== Shaders =========================*/
      ...
      var proj_matrix = _matrix.get_projection(40, this.$refs['my-canvas'].width/this.$refs['my-canvas'].height, 1, 100);
